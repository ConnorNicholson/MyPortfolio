            ...
            <footer className="page_footer fixed-bottom">
                <div className="footer_container">
                    <div className="footer_info footer_social_media_links">
                        <a href="https://www.linkedin.com/in/connor-nicholson-703b0b195/" target="_blank" rel="noopener noreferrer"><i className="fa fa-linkedin-square" aria-hidden="true"></i></a>
                    ...
                    <div className="footer_info">
                        ...
                        <p className="footer_last_updated">Last Updated: 12/6/2019</p>
                    </div>
