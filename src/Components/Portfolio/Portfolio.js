        ...
        <div>
            <section className="portfolio_header">
                <div className="portfolio_flex_container">
                    <div id="gateway_display" className="portfolio_box">
                        ...
                        <span className="gateway_text">Gateway Travel Site</span>
                    </div>
                    ...
                    <div id="nodeJS_display" className="portfolio_box">
                        ...
                        <span className="nodeJS_text">NodeJS Employee Endpoints</span>
                    </div>
                    <div id="react_display" className="portfolio_box">
                        ...
                        <span className="react_text">Portfolio</span>
                    </div>
                    <div id="csharp_display" className="portfolio_box">
                        ...
                        <span className="csharp_text">C# Challenge</span>
                    </div>
                    <div id="pwa_display" className="portfolio_box">
                        ...
                        <span className="pwa_text">Progressive Web App</span>
                    </div>
                </div>
                <Footer />
            </section>
